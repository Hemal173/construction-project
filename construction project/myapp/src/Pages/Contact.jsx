...
function Contact(props) {
    ...
    function handleEvent(e)
    {
        ...
        axios({
            method: "post",
            url: "http://127.0.0.1/api/insertpro.php",
            data: data,
              ...
              <div className="contact-form bg-light p-5">
                <div className="row g-3">
                  ...
                  <div className="col-12 col-sm-6">
                    <input type="text" className="form-control border-0" placeholder="Your Name" onChange={(e)=>setName(e.target.value)} style={{height: '55px'}} />
                  </div>
                  <div className="col-12 col-sm-6">
                    <input type="email" className="form-control border-0" placeholder="Your Email" onChange={(e)=>setEmail(e.target.value)} style={{height: '55px'}} />
                  </div>
                  <div className="col-12">
                    <input type="password" className="form-control border-0" placeholder="password" onChange={(e)=>setPassword(e.target.value)} style={{height: '55px'}} />
                  </div><br></br>
                  <div className="col-12">
                    <input type="city" className="form-control border-0" placeholder="city" onChange={(e)=>setCity(e.target.value)} style={{height: '55px'}} />
                  </div>
                  <div className="col-12">
                    <textarea className="form-control border-0" rows={4} placeholder="address"   onChange={(e)=>setAddress(e.target.value)} defaultValue={""} />
                  </div>
                  <div className="col-12">
                    <button className="btn btn-primary w-100 py-3" type="submit">Send Message</button>
                  </div>
                  <Link to='/showdata'>
                <button className="pt"> view Data</button>
            </Link>
            </div>
            </div>
