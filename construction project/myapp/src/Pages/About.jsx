          ...
          <form onSubmit={handleEvent}>
            <div className="row g-3">
              <div className="col-12 col-sm-6">
                <input type="name"  className="form-control bg-light border-0" onChange={(e)=>setName(e.target.value)} placeholder="Your Name"  style={{ height: 55 }}  />
              </div>
              <div className="col-12 col-sm-6">
                <input type="email"  className="form-control bg-light border-0" onChange={(e)=>setEmail(e.target.value)} placeholder="Your Email"  style={{ height: 55 }} />
              </div>
              <div className="col-12 col-sm-6">
                <div className="date" id="date" data-target-input="nearest">
                  <input type="text" className="form-control bg-light border-0 datetimepicker-input" onChange={(e)=>setDate(e.target.value)} placeholder="Call Back Date Example( date and month - 01 july)" data-target="#date"  data-toggle="datetimepicker"  style={{ height: 55 }}  />
                </div>
              </div>
              <div className="col-12 col-sm-6">
                <div className="time" id="time" data-target-input="nearest">
                  <input
                    ...
                    placeholder="Call Back Time (2:00 pm)"
                    // data-target="#time"
              ...
              <div className="col-12">
                <button className="btn btn-primary w-100 py-3" type="submit" Link to='/contact'>
                  Submit Request
                </button>
              </div>
            </div>
